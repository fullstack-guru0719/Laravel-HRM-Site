                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="email" class="form-control"  name="email" value="<?php echo e($current_employee->birthday); ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="email" class="form-control"  placeholder="employee email" value="<?php echo e($current_employee->em_email); ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control"  name="em_number" value="<?php echo e($current_employee->em_number); ?>" readonly required>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control fc-datepicker"  name="join_date" value="<?php echo e($current_employee->join_date); ?>" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control"  name="salary_amount" value="<?php echo e($current_employee->salary_amount); ?>" required>
                                        </div>
                                    </div>
                                </div>
