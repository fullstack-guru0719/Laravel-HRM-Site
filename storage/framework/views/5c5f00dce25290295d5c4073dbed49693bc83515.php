                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        ...
                                        <a href="<?php echo e(url('task/task-restore/'.$task->id)); ?>" class="action-btns1" data-toggle="tooltip" data-placement="top" title="Restore"><i class="fa fa-mail-reply"></i></a>
                                        <a href="<?php echo e(url('task/task-empty/'.$task->id)); ?>" class="action-btns1" data-toggle="tooltip" data-placement="top" title="Empty Task"><i class="feather feather-trash-2 text-danger"></i></a>
                                    </div>
                                </td>
                            </tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\practice_by_++\Laravel-HRM-Site\resources\views\common_pages\task-dashboard\deleted-list.blade.php ENDPATH**/ ?>