							...
							<div class="col-lg-12 col-md-12">
									...
									<div class=" card-body">
										<div class="row">
											<div class="col-md-3">
												<span>
													<img src="<?php echo e(URL::asset('face-recognition/test/'.$name)); ?>" alt="img" class="lg bradius">
												</span>
											</div>
											<div class="col-md-9">
												<?php $__currentLoopData = $att_results; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $att_result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
													<div class="row">
														<span>
															<img src="<?php echo e(URL::asset('face-recognition/train/'.$att_result.'.jpg')); ?>" alt="img" class="avatar-lg bradius">
														</span>
														<p><?php echo e($att_result); ?></p>
													</div>	
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\practice_by_++\Laravel-HRM-Site\resources\views\common_pages\hrm\time-attendance\face-view.blade.php ENDPATH**/ ?>