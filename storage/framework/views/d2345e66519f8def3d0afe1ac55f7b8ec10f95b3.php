                        ...
                        <table class="table  table-vcenter text-nowrap table-bordered border-bottom table-striped" id="hr-attendance1">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a class="btn btn-light btn-icon btn-sm" href="<?php echo e(url('hr-overviewcldr')); ?>"  data-toggle="tooltip" data-original-title="View">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <span class="avatar avatar brround mr-3" style="background-image: url(<?php echo e(URL::asset('assets/images/users/6.jpg')); ?>)"></span>
                                        <div class="mr-3 mt-0 mt-sm-2 d-block">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <span class="avatar avatar brround mr-3" style="background-image: url(<?php echo e(URL::asset('assets/images/users/14.jpg')); ?>)"></span>
                                        <div class="mr-3 mt-0 mt-sm-2 d-block">
...
<?php $__env->startSection('scripts'); ?>
    ...
    <!-- INTERNAL Index js-->
    <script src="<?php echo e(URL::asset('assets/js/hr/hr-attview.js')); ?>"></script>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\practice_by_++\Laravel-HRM-Site\resources\views\common_pages\hrm\time-attendance\hr-attview.blade.php ENDPATH**/ ?>