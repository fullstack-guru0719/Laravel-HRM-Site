...
<?php $__env->startSection('content'); ?>
    ...
    <div class="page-header d-xl-flex d-block">
        <div class="page-leftheader">
            <h4 class="page-title">DMS<span class="font-weight-normal text-muted ml-2">Meetings</span></h4>
        </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-8">
                                    <div class="mt-0 text-left"> <span class="fs-18 font-weight-semibold">Total Meetings</span>
                                        <h2 class="mb-0 mt-1 mb-2"><?php echo sizeof($meetings); ?></h2>
                                    </div>
                                </div>
                                <div class="col-4">
                ...
                <div class="col-xl-4 col-lg-6 col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-8">
                                    <div class="mt-0 text-left"> <span class="fs-18 font-weight-semibold">Meetings this year</span>
                                        <h2 class="mb-0 mt-1 mb-2"><?php echo e(sizeof($year_meetings_ids)); ?></h2>
                                    </div>
                                </div>
                                <div class="col-4">
                ...
                <div class="col-xl-4 col-lg-12 col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-8">
                                    <div class="mt-0 text-left"> <span class="fs-18 font-weight-semibold">Meetings this month</span>
                                        <h2 class="mb-0 mt-1  mb-2"><?php echo e(sizeof($month_meetings_ids)); ?></h2> </div>
                                </div>
                                <div class="col-4">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\practice_by_++\Laravel-HRM-Site\resources\views\common_pages\meeting-dashboard\index.blade.php ENDPATH**/ ?>