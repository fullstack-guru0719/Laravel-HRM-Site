    ...
    <div class="app-sidebar3">
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a href="<?php echo e(url('hrm/index')); ?> " class="slide-item">Dashboard</a></li>
                    ...
                    <li><a href="<?php echo e(url('hrm/hr-holiday')); ?> " class="slide-item">Holidays</a></li>
                    <li><a href="<?php echo e(url('hrm/hr-notice')); ?> " class="slide-item">Notice Board</a></li>
                    <li><a href="<?php echo e(url('hrm/hr-expenses')); ?> " class="slide-item">Expenses</a></li>
                    <li class="sub-slide">
                    ...
                    <li><a href="<?php echo e(url('hrm/hr-events')); ?> " class="slide-item">Events</a></li>
                    <li><a href="<?php echo e(url('hrm/hr-settings')); ?> " class="slide-item">Settings</a></li>
                </ul>
            </li>
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="#">
...
<!--aside closed-->
<?php /**PATH E:\practice_by_++\DMS\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>