        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    <li><a href="<?php echo e(url('recycle/deleted_mom/deleted_list')); ?> " class="slide-item">Deleted_MOM</a></li>
                    <li><a href="<?php echo e(url('recycle/deleted_order/deleted_list')); ?> " class="slide-item">Deleted_Order</a></li>
                    <li><a href="<?php echo e(url('recycle/deleted_task/deleted_list')); ?> " class="slide-item">Deleted_Task</a></li>
                    <li><a href="<?php echo e(url('recycle/deleted_project/deleted_list')); ?> " class="slide-item">Deleted_Project</a></li>
                </ul>
            </li>
