                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input class="form-control date" id="date" name="start_date" placeholder="DD-MM-YYYY" type="text" >
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">             
                                                <div class="wd-150 mg-b-30">
                                                    <div class="input-group">
                                                        ...
                                                        <input class="form-control timepicker" name="start_time"  type="text" placeholder="Set time" type="text" >
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input class="form-control date" name="end_date" placeholder="DD-MM-YYYY" type="text" >
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <div class="wd-150 mg-b-30">
                                                    <div class="input-group">
                                                        ...
                                                        <input class="form-control timepicker"  name="end_time" placeholder="Set time" type="text" >
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\practice_by_++\DMS\resources\views/common_pages/meeting-dashboard/meeting-new.blade.php ENDPATH**/ ?>