...
<?php $__env->startSection('content'); ?>
    ...
    <div class="page-header d-xl-flex d-block">
        <div class="page-leftheader">
            <h4 class="page-title">Deleted Project List</h4>
        </div>
                        ...
                        <table class="table  table-vcenter text-nowrap table-bordered border-bottom" id="project-list">
                            ...
                            <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <a href="<?php echo e(url('project/project-restore/'.$project[0]->parent_project_id)); ?>" class="action-btns1" data-toggle="tooltip" data-placement="top" title="Restore"><i class="fa fa-mail-reply"></i></a>
                                            ...
                                            <a href="<?php echo e(url('project/project-empty/'.$project[0]->parent_project_id)); ?>" class="action-btns1" data-toggle="tooltip" data-placement="top" title="Empty Project"><i class="feather feather-trash-2 text-danger"></i></a>
                                        </div>
                                    </td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\practice_by_++\Laravel-HRM-Site\resources\views\common_pages\project-dashboard\deleted-list.blade.php ENDPATH**/ ?>