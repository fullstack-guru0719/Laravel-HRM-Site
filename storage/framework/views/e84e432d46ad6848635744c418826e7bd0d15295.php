...
<link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('assets/signature/signature.css')); ?>">
...
<style>
    ...
    #sig canvas{ width: 90% !important; height: auto;}
</style>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        <div class="col-xl-12 col-md-12 col-lg-12">
            <form method="POST" action="<?php echo e(url('workOrder/workOrder-create')); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <input class="form-control" name="work_order" value="<?php echo e($order_number); ?>" readonly required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Bill to:</label> 
                                <div class="form-group">
                                    <input class="form-control" name="bill_to" placeholder="Customer Name" required>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <input class="form-control" name="order_taken_by" placeholder="Representative" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <input class="form-control" name="ref" placeholder="if available" required>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input class="form-control date" name="start_date" placeholder="DD-MM-YYYY" type="text" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <div class="wd-150 mg-b-30">
                                                    <div class="input-group">
                                                        ...
                                                        <input class="form-control timepicker" name="start_time" placeholder="Set time" type="text" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="row container">
                                <div class="form-group">
                                    ...
                                    <label class="custom-control custom-checkbox">
                                        ...
                                        <span class="custom-control-label with-input">Other<input class="form-control" placeholder="Specify" type="text"></span>
                                    </label>
                                    <label class="custom-control ">
                                        <span class="">Technician Names<input class="form-control" name="tech_name" placeholder="Technician Name" type="text"></span>
                                    </label>
                                </div>
                        </div>
                ...
                <div class="card">
                    <div style="margin: 0px 10px; border-bottom: 1px solid #000;"><h4>Description of Work</h4></div>
                    <div class="card-body">
                        <div class="form-group">
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script type="text/javascript" src="<?php echo e(URL::asset('assets/signature/signature.js')); ?>"></script>
    <script>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\practice_by_++\Laravel-HRM-Site\resources\views\common_pages\work-order-dashboard\work-order-new.blade.php ENDPATH**/ ?>