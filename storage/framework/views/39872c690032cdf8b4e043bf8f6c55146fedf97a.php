...
<div class="sidebar sidebar-right sidebar-animate">
    ...
    <div class="">
        <div class="list-group-item  align-items-center border-0">
            <div class="d-flex">
                <span class="avatar avatar-lg brround mr-3" style="background-image: url(<?php echo e(URL::asset('assets/images/users/4.png')); ?>)"></span>
                <div class="mt-1">
        ...
        <div class="list-group-item  align-items-center  border-bottom">
            <div class="d-flex">
                <span class="avatar avatar-lg brround mr-3" style="background-image: url(<?php echo e(URL::asset('assets/images/users/10.png')); ?>)"></span>
                <div class="mt-1">
        ...
        <div class="list-group-item  align-items-center  border-bottom">
            <div class="d-flex">
							<span class="avatar avatar-lg brround mr-3" style="background-image: url(<?php echo e(URL::asset('assets/images/users/9.png')); ?>)">
        ...
        <div class="list-group-item  align-items-center  border-bottom">
            <div class="d-flex">
							<span class="avatar avatar-lg brround mr-3" style="background-image: url(<?php echo e(URL::asset('assets/images/users/5.png')); ?>)">
        ...
        <div class="list-group-item  align-items-center  border-bottom">
            <div class="d-flex">
							<span class="avatar avatar-lg brround mr-3" style="background-image: url(<?php echo e(URL::asset('assets/images/users/12.png')); ?>)">
								<span class="avatar-status bg-green"></span>
							</span>
                <div class="mt-1">
                    <a href="#" class="font-weight-semibold fs-16">Vinny<span class="text-muted font-weight-normal"> shared your post</span></a>
        ...
        <div class="list-group-item  align-items-center  border-bottom">
            <div class="d-flex">
                <span class="avatar avatar-lg brround mr-3" style="background-image: url(<?php echo e(URL::asset('assets/images/users/8.png')); ?>)">	</span>
                <div class="mt-1">
        ...
        <div class="list-group-item  align-items-center  border-bottom">
            <div class="d-flex">
                <span class="avatar avatar-lg brround mr-3" style="background-image: url(<?php echo e(URL::asset('assets/images/users/14.png')); ?>)">	</span>
                <div class="mt-1">
        ...
        <div class="list-group-item  align-items-center  border-bottom">
            <div class="d-flex">
                <span class="avatar avatar-lg brround mr-3" style="background-image: url(<?php echo e(URL::asset('assets/images/users/3.png')); ?>)">	</span>
                <div class="mt-1">
...
<!--/Sidebar-right-->
<?php /**PATH E:\practice_by_++\Laravel-HRM-Site\resources\views/layouts/right-sidebar.blade.php ENDPATH**/ ?>