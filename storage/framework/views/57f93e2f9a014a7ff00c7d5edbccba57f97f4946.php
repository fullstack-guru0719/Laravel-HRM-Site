        ...
        <div class="container" style="padding: 100px 150px 150px 0px">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <img src="<?php echo e(URL::asset('assets/images/brand/pdf_convert_head.png')); ?>" class="header-brand-img" alt="HSW ENERGY" style="width:400px;height:180px;">
                </div>
            </div>
...
<?php /**PATH E:\practice_by_++\Laravel-HRM-Site\resources\views\common_pages\meeting-dashboard\meeting-convert-pdf.blade.php ENDPATH**/ ?>