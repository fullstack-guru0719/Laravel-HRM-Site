            ...
            <div class="card user-pro-list overflow-hidden">
                <div class="card-body">
                    <div class="user-pic text-center">
                        <span class="avatar avatar-xxl brround" style="background-image: url(<?php echo e(URL::asset('assets/images/users/1.jpg')); ?>)">
                            ...
                            <div class="table-responsive">
                                <table class="table  table-vcenter text-nowrap table-bordered border-bottom" id="task-profile">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <a href="<?php echo e(url('task-view')); ?>" class="action-btns1" data-toggle="tooltip" data-placement="top" title="View Task"><i class="feather feather-eye text-primary"></i></a>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <!-- INTERNAL Index js-->
    <script src="<?php echo e(URL::asset('assets/js/task/task-profile.js')); ?>"></script>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\practice_by_++\Laravel-HRM-Site\resources\views\common_pages\task-dashboard\task-profile.blade.php ENDPATH**/ ?>