...
@section('content')
    ...
    <div class="page-header d-xl-flex d-block">
        <div class="page-leftheader">
            <h4 class="page-title"><span class="font-weight-normal text-muted mr-2">{{ $current_task->t_number }}</span> {{ $current_task->t_title }} </h4>
        </div>
            ...
            <div class="d-flex align-items-end flex-wrap my-auto right-content breadcrumb-right">
                <div class="row">
                    <div class="col-md-2 btn-list">
                        {{--  <a href="{{url('task/task-new')}}" class="btn btn-primary " ><i class="feather feather-plus fs-15 my-auto mr-2"></i>Add</a>
                    </div>
                    <div class="col-md-2 btn-list">
                    ...
                    <div class="col-md-2 btn-list">
                        <a href="{{url('task/task-edit/'.$current_task->id)}}" class="btn btn-primary " ><i class="feather feather-edit-2  text-success"></i> EDIT</a>
                    </div>
                </div>
                    ...
                    <div class="table-responsive mt-5">
                        <table class="table mb-0">
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <span class="font-weight-semibold">{!! $current_task->start_date !!}</span>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>:</td>
                                <td>
                                    <span class="font-weight-semibold">{!! $current_task->end_date !!}</span>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                            ...
                                            <div class="list-group-item  align-items-center">
                                                <div class="d-md-flex">
                                                    ...
                                                    <div class="ml-auto d-flex mt-4 text-right">
                                                        <a href="{{url('task/task_file-download/'.$file->id)}}" class="action-btns1"><i class="feather feather-download-cloud text-primary"></i></a>
                                                        <a href="{{url('task/task_file-delete/'.$file->id)}}" class="action-btns1  mr-0"><i class="feather feather-trash-2 text-danger"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div> 
