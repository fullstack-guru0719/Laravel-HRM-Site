...
@section('content')
    ...
    <div class="page-header d-xl-flex d-block">
        <div class="page-leftheader">
            <h4 class="page-title">Deleted Task List</h4>
        </div>
        ...
        <div class="col-xl-12 col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header  border-0">
                    <h4 class="card-title">Deleted Tasks History</h4>
                </div>
                <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        ...
                                        <a href="{{url('task/task-restore/'.$task->id)}}" class="action-btns1" data-toggle="tooltip" data-placement="top" title="Restore"><i class="fa fa-mail-reply"></i></a>
                                        <a href="{{url('task/task-empty/'.$task->id)}}" class="action-btns1" data-toggle="tooltip" data-placement="top" title="Empty Task"><i class="feather feather-trash-2 text-danger"></i></a>
                                    </div>
                                </td>
                            </tr>
                            @endforeach
