...
@section('content')
    ...
    <div class="page-header d-xl-flex d-block">
       ...
       <div class="page-rightheader ml-md-auto">
            <div class="d-flex align-items-end flex-wrap my-auto right-content breadcrumb-right">
                <div class="btn-list">
                    <a href="{{url('task/task-new')}}" class="btn btn-primary "><i class="feather feather-plus fs-15 my-auto mr-2"></i>Create New Task</a>
                 </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-xl-3 col-lg-6 col-md-12">
            <div class="card">
                <a href="{{url('task/task-list')}}">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-7">
                                <div class="mt-0 text-left">
                                    <span class="fs-16 font-weight-semibold">Total Tasks</span>
                                    <h3 class="mb-0 mt-1 text-danger  fs-25">{!! sizeof($tasks) !!}</h3>
                                </div>
                            </div>
                            <div class="col-5">
        ...
        <div class="col-xl-3 col-lg-6 col-md-12">
            <div class="card">
                <a href="{{url('task/task-running')}}">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-7">
                                <div class="mt-0 text-left">
                                    <span class="fs-16 font-weight-semibold">In Progress Tasks</span>
                                    <h3 class="mb-0 mt-1 text-primary  fs-25">{!! sizeof($in_progress_tasks) !!}</h3>
                                </div>
                            </div>
                            <div class="col-5">
        ...
        <div class="col-xl-3 col-lg-6 col-md-12">
            <div class="card">
                <a href="{{url('task/task-hold')}}">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-7">
                                <div class="mt-0 text-left">
                                    <span class="fs-16 font-weight-semibold">Not Started Tasks</span>
                                    <h3 class="mb-0 mt-1 text-warning  fs-25">{!! sizeof($not_started_tasks) !!}</h3>
                                </div>
                            </div>
                            <div class="col-5">
        ...
        <div class="col-xl-3 col-lg-6 col-md-12">
            <div class="card">
                <a href="{{url('task/task-complete')}}">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-7">
                                <div class="mt-0 text-left">
                                    <span class="fs-16 font-weight-semibold">Completed Tasks</span>
                                    <h3 class="mb-0 mt-1 text-success fs-25">{!! sizeof($completed_tasks) !!}</h3>
                                </div>
                            </div>
                            <div class="col-5">
        ...
        <div class="col-xl-12 col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header  border-0">
                    <h4 class="card-title">Tasks History</h4>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table  table-vcenter text-nowrap table-bordered border-bottom" id="task-list">
                            <thead>
                            <tr>
                                <th class="border-bottom-0 text-center">Task Number</th>
                            ...
                            <tr>
                                <td class="text-center">{!! $task->t_number !!}</td>
                                <td>
                                    <a href="{{url('task/task-view/'.$task->id)}}" class="d-flex sidebarmodal-collpase">
                                        <span class="bg-warning dot-label1 mr-2 mt-1"></span>
                                        <span>{!! $task->t_title !!}</span>
                                    </a>
                                </td>
                                <td>{!! $task->department->department_name !!}</td>
                                <td>
                                    <a href="{{url('task/task-profile')}}" class="d-flex">
                                        ...
                                        <div class="mr-3 mt-0 mt-sm-2 d-block">
                                            <h6 class="mb-1 fs-14">{!! $task->user->user_id !!}</h6>
                                        </div>
                                    </a>
                                </td>
                                <td>
                                    @if($task->t_priority == 1)
                                        <span class="badge badge-danger-light">High</span>
                                    @elseif($task->t_priority == 2) 
                                        <span class="badge badge-warning-light">Medium</span>
                                    @else<span class="badge badge-success-light">Low</span></td>
                                    @endif
                                </td>
                                <td>{!! \Illuminate\Support\Carbon::createFromFormat('Y-m-d',$task->start_date)->format('d-m-Y') !!}</td>
                                <td>{!! \Illuminate\Support\Carbon::createFromFormat('Y-m-d',$task->end_date)->format('d-m-Y')  !!}</td>
                                <td>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <a href="{{url('task/task-view/'.$task->id)}}" class="action-btns1" data-toggle="tooltip" data-placement="top" title="View Task"><i class="feather feather-eye text-primary"></i></a>
                                        <a href="{{url('task/task-edit/'.$task->id)}}" class="action-btns1">
                                            <i class="feather feather-edit-2  text-success" data-toggle="tooltip" data-placement="top" title="Edit Task"></i>
                                        </a>
                                        <a href="{{url('task/task-delete/'.$task->id)}}" class="action-btns1" data-toggle="tooltip" data-placement="top" title="Delete Task"><i class="feather feather-trash-2 text-danger"></i></a>
                                    </div>
                                </td>
                            </tr>
                            @endforeach
