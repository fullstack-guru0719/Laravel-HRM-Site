        ...
        <div class="col-xl-3 col-md-12 col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="mb-5">
                        <div class="d-flex">
                            <span class="avatar avatar-lg bradius bg-light mr-4" style="background-image: url({{URL::asset('assets/images/files/company/img1.png')}})"></span>
                            <div class="mt-1">
                    ...
                    <div class="mb-5">
                        <div class="d-flex">
                            <span class="avatar avatar-lg bradius bg-light mr-4" style="background-image: url({{URL::asset('assets/images/files/company/img2.png')}})"></span>
                            <div class="mt-2">
                    ...
                    <div class="mb-5">
                        <div class="d-flex">
                            <span class="avatar avatar-lg bradius bg-light mr-4" style="background-image: url({{URL::asset('assets/images/files/company/img3.png')}})"></span>
                            <div class="mt-2">
                    ...
                    <div class="mb-5">
                        <div class="d-flex">
                            <span class="avatar avatar-lg bradius bg-light mr-4" style="background-image: url({{URL::asset('assets/images/files/company/img4.png')}})"></span>
                            <div class="mt-2">
                    ...
                    <div class="mb-0">
                        <div class="d-flex">
                            <span class="avatar avatar-lg bradius bg-light mr-4" style="background-image: url({{URL::asset('assets/images/files/company/img5.png')}})"></span>
                            <div class="mt-2">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-5">
                        <div class="list-group-item d-flex p-0  align-items-center border-0">
                            <div class="d-flex">
                                <span class="avatar avatar-lg bradius mr-3" style="background-image: url({{URL::asset('assets/images/users/13.jpg')}})"></span>
                                <div class="mt-1">
                                    <h6 class="mb-1 font-weight-semibold fs-16">James Paige
                                        <span class="font-weight-normal text-muted">Update</span> new Version <span class="font-weight-normal text-muted">angular 10.4....</span>
                                    </h6>
                    ...
                    <div class="table-responsive mb-0 table-regcompany">
                        <table class="table table-vcenter text-nowrap  border-top mb-0" id="admin-regtable">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#" class="d-flex">
                                        <span class="avatar avatar-lg bg-transparent brround mr-3" style="background-image: url({{URL::asset('assets/images/files/company/img1.png')}})"></span>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#" class="d-flex">
                                        <span class="avatar avatar-lg bg-transparent brround mr-3" style="background-image: url({{URL::asset('assets/images/files/company/img2.png')}})"></span>
                                        <div class="mr-3 mt-0 mt-sm-2 d-block">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#" class="d-flex">
                                        <span class="avatar avatar-lg bg-transparent brround mr-3" style="background-image: url({{URL::asset('assets/images/files/company/img4.png')}})"></span>
                                        <div class="mr-3 mt-0 mt-sm-2 d-block">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#" class="d-flex">
                                        <span class="avatar avatar-lg bg-transparent brround mr-3" style="background-image: url({{URL::asset('assets/images/files/company/img5.png')}})"></span>
                                        <div class="mr-3 mt-0 mt-sm-2 d-block">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#" class="d-flex">
                                        <span class="avatar avatar-lg bg-transparent brround mr-3" style="background-image: url({{URL::asset('assets/images/files/company/img6.png')}})"></span>
                                        <div class="mr-3 mt-0 mt-sm-2 d-block">
                    ...
                    <div class="table-responsive mb-0 table-regcompany">
                        <table class="table table-vcenter text-nowrap  border-top mb-0" id="admin-inregtable">
                            ...
                            <tr>
                                <td>
                                    <a href="#" class="d-flex">
                                        <span class="avatar avatar-lg bg-transparent brround mr-3" style="background-image: url({{URL::asset('assets/images/files/company/img7.png')}})"></span>
                                        <div class="mr-3 mt-0 mt-sm-2 d-block">
                            ...
                            <tr>
                                <td>
                                    <a href="#" class="d-flex">
                                        <span class="avatar avatar-lg bg-transparent brround mr-3" style="background-image: url({{URL::asset('assets/images/files/company/img8.png')}})"></span>
                                        <div class="mr-3 mt-0 mt-sm-2 d-block">
...
@section('scripts')
    ...
    <!-- INTERNAL Index js-->
    <script src="{{URL::asset('assets/js/index7.js')}}"></script>
