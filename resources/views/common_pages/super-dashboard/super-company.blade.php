                    ...
                    <div class="table-responsive company-table">
                        <table class="table  table-vcenter text-nowrap table-bordered border-bottom" id="company-list">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#" class="d-flex sidebarmodal-collpase">
                                        <span class="avatar avatar-lg bg-transparent brround mr-3" style="background-image: url({{URL::asset('assets/images/files/company/img3.png')}})"></span>
                                        <div class="mt-0 mt-sm-4 d-block">
            ...
            <div class="sidebar-content">
                ...
                <div class="row no-gutters border-bottom">
                    <div class="col-md-6 border-right">
                        <div class="card-body">
                            <div class="mb-5">
                                <span class="avatar avatar-xl bg-transparent brround mr-3" style="background-image: url({{URL::asset('assets/images/files/company/img1.png')}})"></span>
...
@section('scripts')
    ...
    <!-- INTERNAL Index js-->
    <script src="{{URL::asset('assets/js/superadmin/superadmin-company.js')}}"></script>
