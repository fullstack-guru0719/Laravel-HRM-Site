...
@section('styles')
    ...
    <link href="{{URL::asset('assets/plugins/datatable/css/rowGroup.bootstrap4.css')}}" rel="stylesheet" />
...
@section('scripts')
    ...
    <!-- INTERNAL Index js-->
    <script src="{{URL::asset('assets/js/superadmin/superadmin-role.js')}}"></script>
