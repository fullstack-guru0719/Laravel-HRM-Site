   ...
   <div class="row">
        ...
        <div class="card">
            <a href="#">
                <div class="card-body text-center">
                    <span class="avatar avatar-lg bradius fs-20 bg-primary-transparent">{{sizeof($total_orders)}}</span>
    ...
    <div class="col-xl-2 col-lg-6 col-md-12">
        <div class="card">
            <a href="#">
                <div class="card-body text-center">
                    <span class="avatar avatar-lg bradius fs-20 bg-info-transparent">{{sizeof($in_progress_orders)}}</span>
    ...
    <div class="col-xl-2 col-lg-6 col-md-12">
        <div class="card">
            <a href="#">
                <div class="card-body text-center">
                    <span class="avatar avatar-lg bradius fs-20 bg-secondary-transparent">{{sizeof($not_started_orders)}}</span>
    ...
    <div class="col-xl-2 col-lg-6 col-md-12">
        <div class="card">
            <a href="#">
                <div class="card-body text-center">
                    <span class="avatar avatar-lg bradius fs-20 bg-success-transparent">{{sizeof($completed_orders)}}</span>
    ...
    <div class="col-xl-2 col-lg-6 col-md-12">
        <div class="card">
            <a href="#">
                <div class="card-body text-center">
                    <span class="avatar avatar-lg bradius fs-20 bg-danger-transparent">{{ sizeof($canceled_orders) }}</span>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                ...
                                                <a href="{{url('workOrder/workOrder-edit/'.$real_order->id)}}" class="action-btns1">
                                                    <i class="feather feather-edit-2  text-success" data-toggle="tooltip" data-placement="top" title="Edit WorkOrder"></i>
                                                </a>
                                                <a href="{{url('workOrder/workOrder-delete/'.$real_order->id)}}" class="action-btns1" data-toggle="tooltip" data-placement="top" title="Delete WorkOrder"><i class="feather feather-trash-2 text-danger"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                @endforeach
