...
<link rel="stylesheet" type="text/css" href="{{ URL::asset('assets/signature/signature.css') }}">
...
@section('content')
    ...
    <div class="row">
        <div class="col-xl-12 col-md-12 col-lg-12">
            <form method="POST" action="{{ url('workOrder/workOrder-create') }}" enctype="multipart/form-data">
                @csrf
                <div class="card">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <input class="form-control" name="work_order" value="{{ $order_number }}" readonly required>
                                </div>
                            </div>
                            <div class="col-md-6">
...
@section('scripts')
    ...
    <script type="text/javascript" src="{{ URL::asset('assets/signature/signature.js') }}"></script>
    <script>
