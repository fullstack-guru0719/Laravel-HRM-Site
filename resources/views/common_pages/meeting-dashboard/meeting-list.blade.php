    ...
    <div class="row">
            ...
            <div class="card">
                <a href="#">
                    <div class="card-body text-center">
                        <span class="avatar avatar-lg bradius fs-20 bg-primary-transparent">{{sizeof($total_meetings_ids)}}</span>
        ...
        <div class="col-xl-2 col-lg-6 col-md-12">
            <div class="card">
                <a href="#">
                    <div class="card-body text-center">
                        <span class="avatar avatar-lg bradius fs-20 bg-info-transparent">{{ sizeof($in_progress_meetings_ids) }}</span>
        ...
        <div class="col-xl-2 col-lg-6 col-md-12">
            <div class="card">
                <a href="#">
                    <div class="card-body text-center">
                        <span class="avatar avatar-lg bradius fs-20 bg-secondary-transparent">{{ sizeof($not_started_meetings_ids) }}</span>
        ...
        <div class="col-xl-2 col-lg-6 col-md-12">
            <div class="card">
                <a href="#">
                    <div class="card-body text-center">
                        <span class="avatar avatar-lg bradius fs-20 bg-success-transparent">{{ sizeof($completed_meetings_ids) }}</span>
        ...
        <div class="col-xl-2 col-lg-6 col-md-12">
            <div class="card">
                <a href="#">
                    <div class="card-body text-center">
                        <span class="avatar avatar-lg bradius fs-20 bg-danger-transparent">{{ sizeof($cancel_meetings_ids) }}</span>
                        ...
                        <table class="table  table-vcenter text-nowrap table-bordered border-bottom" id="meeting-list">
                            ...
                            @foreach($meetings as $meeting )
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <a href="{{url('meeting/meeting-convert/'.$meeting[0]->parent_meeting_id)}}" class="action-btns1" data-toggle="tooltip" data-placement="top" title="Generate PDF"><i class="fa fa-file-text"></i></a>
                                            ...
                                            <a href="{{url('meeting/meeting-delete/'.$meeting[0]->parent_meeting_id)}}" class="action-btns1" data-toggle="tooltip" data-placement="top" title="Delete Meeting"><i class="feather feather-trash-2 text-danger"></i></a>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
