        ...
        <div class="page-rightheader ml-md-auto">
            <div class="d-flex align-items-end flex-wrap my-auto right-content breadcrumb-right">
                <div class="btn-list mt-3 mt-lg-0">
                    <a href="{{url('hr-addpayroll')}}" class="btn btn-primary mr-3">Add New Payroll</a>
                        ...
                        <table class="table  table-vcenter text-nowrap table-bordered border-bottom" id="hr-payroll">
                            ...
                            <tr>
                                ...
                                <td class="text-left">
                                    ...
                                    <a href="{{url('hr-editpayroll')}}" class="action-btns" data-toggle="tooltip" data-placement="top" title="Edit">
    ...
    <div class="modal fade"  id="viewsalarymodal">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <div>
                        <img src="{{URL::asset('assets/images/brand/logo.png')}}" class="header-brand-img" alt="Dayonelogo">
                    </div>
                    <div class="ml-auto">
...
@section('scripts')
    ...
    <!-- INTERNAL Index js-->
    <script src="{{URL::asset('assets/js/hr/hr-payroll.js')}}"></script>
