                            ...
                            <div class="table-responsive recent_jobs pt-2 pb-2 pl-2 pr-2 card-body">
                                <table class="table mb-0 text-nowrap">
                                    ...
                                    <tr class="border-bottom">
                                        <td>
                                            <div class="d-flex">
                                                <img src="{{URL::asset('assets/images/users/16.jpg')}}" alt="img" class="avatar avatar-md brround mr-3">
                                                <div class="mr-3 mt-0 mt-sm-1 d-block">
                                    ...
                                    <tr class="border-bottom">
                                        <td>
                                            <div class="d-flex">
                                                <img src="{{URL::asset('assets/images/users/1.jpg')}}" alt="img" class="avatar avatar-md brround mr-3">
                                                <div class="mr-3 mt-0 mt-sm-1 d-block">
                                    ...
                                    <tr class="border-bottom">
                                        <td>
                                            <div class="d-flex">
                                                <img src="{{URL::asset('assets/images/users/4.jpg')}}" alt="img" class="avatar avatar-md brround mr-3">
                                                <div class="mr-3 mt-0 mt-sm-1 d-block">
                                    ...
                                    <tr class="border-bottom">
                                        <td>
                                            <div class="d-flex">
                                                <img src="{{URL::asset('assets/images/users/8.jpg')}}" alt="img" class="avatar avatar-md brround mr-3">
                                                <div class="mr-3 mt-0 mt-sm-1 d-block">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex">
                                                <img src="{{URL::asset('assets/images/users/9.jpg')}}" alt="img" class="avatar avatar-md brround mr-3">
                                                <div class="mr-3 mt-0 mt-sm-1 d-block">
                                                    <h6 class="mb-0">Kimberly Berry</h6>
                                                    <div class="clearfix"></div>
                                                    <small>Senior Prototyper</small>
                                ...
                                <table class="table mb-0 text-nowrap">
                                    ...
                                    <tr class="border-bottom">
                                        <td>
                                            <div class="d-flex">
                                                <div class="table_img brround bg-light mr-3">
                                                    <img src="{{URL::asset('assets/images/photos/html.png')}}" alt="img" class=" bg-light brround">
                                                </div>
                                                <div class="mr-3 mt-3 d-block">
                                    ...
                                    <tr class="border-bottom">
                                        <td>
                                            <div class="d-flex">
                                                <div class="table_img brround bg-light mr-3">
                                                    <img src="{{URL::asset('assets/images/photos/jquery.png')}}" alt="img" class=" bg-light brround">
                                                </div>
                                                <div class="mr-3 mt-3 d-block">
                                    ...
                                    <tr class="border-bottom">
                                        <td>
                                            <div class="d-flex">
                                                <div class="table_img brround bg-light mr-3">
                                                    <img src="{{URL::asset('assets/images/photos/vue.png')}}" alt="img" class=" bg-light brround">
                                                </div>
                                                <div class="mr-3 mt-3 d-block">
