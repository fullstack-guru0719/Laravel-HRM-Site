                    ...
                    <div class="row">
                        <div class="col-7">
                            <div class="mt-0 text-left">
                                ...
                                <h3 class="mb-0 mt-1 text-primary fs-25">{!! sizeof($parent_ids) !!}</h3>
                            </div>
                        </div>
                        <div class="col-5">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-9">
                                        <div class="mt-0 text-left">
                                            <a href="{{url('project/project-view')}}" class="mb-0 mt-1 mb-2 font-weight-semibold h4">Adobe XD</a>
                                ...
                                <div class="d-md-flex">
                                    <div class="d-flex mb-3 mb-md-0">
                                        <div class="avatar-list avatar-list-stacked">
                                            <span class="avatar avatar-md brround" style="background-image: url({{URL::asset('assets/images/users/1.png')}})"></span>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-9">
                                        <div class="mt-0 text-left">
                                            <a href="{{url('project/project-view')}}" class="mb-0 mt-1 mb-2 font-weight-semibold h4">HTML</a>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-9">
                                        <div class="mt-0 text-left">
                                            <a href="{{url('project/project-view')}}" class="mb-0 mt-1 mb-2 font-weight-semibold h4">Angular</a>
