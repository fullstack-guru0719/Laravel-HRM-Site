                        ...
                        <table class="table  table-vcenter text-nowrap table-bordered border-bottom" id="project-list">
                            ...
                            @foreach($projects as $project)
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <a href="{{url('project/project-restore/'.$project[0]->parent_project_id)}}" class="action-btns1" data-toggle="tooltip" data-placement="top" title="Restore"><i class="fa fa-mail-reply"></i></a>
                                            ...
                                            <a href="{{url('project/project-empty/'.$project[0]->parent_project_id)}}" class="action-btns1" data-toggle="tooltip" data-placement="top" title="Empty Project"><i class="feather feather-trash-2 text-danger"></i></a>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
