    ...
    <div class="container-fluid">
        <div class="d-flex">
            ...
            <div class="d-flex order-lg-2 my-auto ml-auto">
                ...
                <div class="dropdown">{{\Illuminate\Support\Facades\Auth::user()->test_role}}</div>
          
                <div class="dropdown profile-dropdown">
                    <a href="#" class="nav-link pr-1 pl-0 leading-none" data-toggle="dropdown">
                        <span>
                            <img src="{{URL::asset('assets/images/users/16.png')}}" alt="img" class="avatar avatar-md bradius">
                        </span>
                    </a>
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow animated">
                        ...
                        <a class="dropdown-item d-flex" href="{{url('user/profile')}}">
                        ...
                        <a class="dropdown-item d-flex" href="{{url('hrm/employee/hr-addemployee')}}">
